...
- **`explainer-video`** — `.github/skills/explainer-video/SKILL.md` — Manim-based animated explainer video production for {{PERSONAL_DOMAIN}}. Use when creating technical animation content (LLM concepts, agent architecture, platform demos).
